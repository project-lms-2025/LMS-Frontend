...
const Teacher = () => {
  ...
  if (loading) return <div className="m-0">
    ...
    <div
      className={`transition-all mt-14 duration-300 ${open ? 'md:ml-[20rem] ml-56 mr-4 w-[40%] md:w-[70%]' : 'ml-24 mr-2 md:w-[90%]  w-[95%]'}`}
    >
      <Loading/>
    </div></div>;
      ...
      >
        <div className=" py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-extrabold text-primary-purple mb-6 text-center">
              Teacher Dashboard
            </h1>
